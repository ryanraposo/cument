...
- Isolated GNOME Wayland test: extension ACTIVE, exact 580 × 968 drawer at x=860/y=32 on a 1440 × 1000 monitor, Alt+Shift+backslash, earmark click, close and reopen, two terminal contexts, background context updates without focus theft, focus restoration, extension INACTIVE after cleanup.
